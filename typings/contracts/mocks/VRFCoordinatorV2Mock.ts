...
export interface VRFCoordinatorV2MockInterface extends utils.Interface {
  functions: {
    ...
    "s_currentSubId()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "s_currentSubId",
    values?: undefined
  ): string;
...
export interface VRFCoordinatorV2Mock extends BaseContract {
  ...
  functions: {
    ...
    s_currentSubId(overrides?: CallOverrides): Promise<[BigNumber]>;
  };
  ...
  populateTransaction: {
    ...
    s_currentSubId(overrides?: CallOverrides): Promise<PopulatedTransaction>;
  };
}
