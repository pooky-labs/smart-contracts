...
export interface MockPookyBallInterface extends utils.Interface {
  functions: {
    ...
    "mock_mintBall(address,(uint8,uint256,uint256,uint256,uint256))": FunctionFragment;
    "mock_setBallInfo(uint256,(uint8,uint256,uint256,uint256,uint256))": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "mock_mintBall",
    values: [PromiseOrValue<string>, BallInfoStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "mock_setBallInfo",
    values: [PromiseOrValue<BigNumberish>, BallInfoStruct]
  ): string;
...
export interface MockPookyBall extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockPookyBallInterface;
